...
export class CrearActividadComponent {
  ...
  public registroID: Actividad = new Actividad(1, 3, " ester", " estaf", "new Date", 0, 1, new Type(1, "sdgg", 1, "sfe"));


  @Input() public tipoActividad: Actividad = new Actividad(1, 1, "jjj", "ggg", "", 0, 1, new Type);
